...
import com.modern_inf.management.controller.mapper.UserDto;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> login(@RequestBody User user) {
        ...
        if (userPrincipal != null) {
            ...
            if (!StringUtils.isNullOrEmpty(refreshToken)) {
                ...
                return ResponseEntity.status(HttpStatus.OK).headers(headers).body(userToUserDTO(userPrincipal.getUser()));
            }
    ...
    public UserDto userToUserDTO(User entity) {
        ...
        userDto.setAsanaPersonalAccessToken(entity.getAsanaPersonalAccessToken());
        userDto.setGitlabPersonalAccessToken(entity.getGitlabPersonalAccessToken());
        userDto.setAwsAccessKey(entity.getAwsAccessKey());
        userDto.setAwsAccessSecretKey(entity.getAwsAccessSecretKey());
